                ...
                <div className="relative group">
                    ...
                    <form onSubmit={submitHandler} className='relative w-full max-w-lg bg-white/10 backdrop-blur-xl border border-purple-400/30 rounded-2xl p-8 shadow-2xl shadow-purple-500/20'>
                        ...
                        <div className='space-y-5'>
                                ...
                                <div className='flex-1'>
                                    ...
                                    <RadioGroup className="flex items-center gap-6">
                                        <div className="flex items-center space-x-3 group cursor-pointer">
                                            ...
                                            />
                                            <Label className="text-gray-300 group-hover:text-purple-300 cursor-pointer font-medium">Student</Label>
                                        </div>
                                        <div className="flex items-center space-x-3 group cursor-pointer">
                                            <Input
                                                type="radio"
                                                ...
                                                className="cursor-pointer w-5 h-5 text-purple-400 bg-white/10 border-purple-400/30 focus:ring-purple-400/20"
                                            />
                                            <Label className="text-gray-300 group-hover:text-purple-300 cursor-pointer font-medium">Recruiter</Label>
                                        </div>
                                    </RadioGroup>
                                </div>
                            ...
                            {input.role === 'student' && (
                                <div className='flex-1'>
                                    <Label className="text-purple-300 font-semibold mb-2 block">Upload Resume</Label>
                                    <div className="relative group">
                                        <Input
                                            accept=".pdf,.doc,.docx"
                                            type="file"
                            ...
                            {/* Button */}
                            {
                                loading ? (
                                    <Button
                                        disabled
                                        className="w-full bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg opacity-70"
                                    >
