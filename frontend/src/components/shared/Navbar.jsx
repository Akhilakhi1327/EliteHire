...
const Navbar = () => {
    ...
    return (
        <div className='relative bg-gradient-to-r from-slate-900 via-purple-900/80 to-slate-900 backdrop-blur-xl border-b border-purple-500/30'>
            ...
            <div className='flex items-center justify-between mx-auto max-w-7xl h-20 px-4 relative z-50'>
                ...
                <div className='flex items-center gap-12'>
                    <ul className='flex font-semibold items-center gap-8 relative z-50'>
                        {
                            user && user.role === 'recruiter' ? (
                                ...
                                <>
                                    <li className="cursor-pointer hover:text-white transition-colors">
                                        <Link
                                            to="/"
                                            className="text-gray-300 hover:text-white transition-colors duration-300 cursor-pointer block"
                                        >
                                            Home
                                        </Link>
                                    </li>
